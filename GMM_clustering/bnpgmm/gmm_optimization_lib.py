...
from bnpmodeling.bnp_optimization_lib import optimize_kl, init_centroids_w_kmeans

from bnpgmm.gmm_clustering_lib import get_kl
from bnpgmm.gmm_posterior_quantities_lib import get_optimal_z_from_vb_dict
